...
const AddBlog = () => {
  ...
  useEffect(() => {
    // initiating the quill only once
  ...
  return (
    ...
    >
      <div className="bg-white w-full max-w-3xl p-4 md:p-10 sm:m-10 shadow rounded">
        ...
        <button disabled={isAdding} type="submit" className="mt-8 w-40 h-10 bg-primary text-white rounded-2xl cursor-pointer text-sm">
